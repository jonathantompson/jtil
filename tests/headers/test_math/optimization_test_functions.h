...
#ifndef JTIL_MATH_OPTIMIZATION_TEST_FUNCTIONS_HEADER
#define JTIL_MATH_OPTIMIZATION_TEST_FUNCTIONS_HEADER
...
#endif  // JTIL_MATH_OPTIMIZATION_TEST_FUNCTIONS_HEADER
